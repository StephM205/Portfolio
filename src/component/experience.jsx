...
const ExperienceItem = ({ exp, index }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="md:hidden text-primary font-medium mb-2">
          {exp.date}
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          <p className="text-white/60 font-medium mb-4 relative z-10">
            {exp.company}
          </p>
          <div className="hidden md:block text-primary font-medium text-sm mb-4 relative z-10">
            {exp.date}
          </div>
